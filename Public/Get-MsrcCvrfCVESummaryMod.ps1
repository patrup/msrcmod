Function Get-MsrcCvrfCVESummaryMod {
<#
    .SYNOPSIS
    ...
    .EXAMPLE
        Get-MsrcCvrfDocumentMod -ID 2016-Nov | Get-MsrcCvrfCVESummaryMod

        Get the CVE summary from a CVRF document using the pipeline.

    .EXAMPLE
        $cvrfDocument = Get-MsrcCvrfDocumentMod -ID 2016-Nov
        Get-MsrcCvrfCVESummaryMod -Vulnerability $cvrfDocument.Vulnerability

Function Get-MsrcSecurityUpdateMod {
<#
    .SYNOPSIS
    ...
    .EXAMPLE
       Get-MsrcSecurityUpdateMod -Before 2017-01-01
    ...
    .EXAMPLE
       Get-MsrcSecurityUpdateMod -Before 2017-01-01 -After 2016-10-01

       Get all the updates before January 1st, 2017 and after October 1st, 2016

    .EXAMPLE
        Get-MsrcSecurityUpdateMod -After (Get-Date).AddDays(-60) -Before (Get-Date)
